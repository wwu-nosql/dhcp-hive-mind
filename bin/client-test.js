...
// Generate random mac address with prefix 54:52:00
// Credit to https://github.com/bahamas10/node-random-mac
function randomMac() {
  var mac = '54:52:00';
...
// Return string of 'num' random words from wordlist
...
// Generate random IP address with given prefix, or 192.168.1
function randomIP(prefix) {
  var ip = prefix || '192.168.1.';
  return ip += Math.floor(Math.random() * (255 - 2) + 2);
}

// Generate random broadcast message and return JSON object
